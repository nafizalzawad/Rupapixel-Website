...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#120a22] text-white pt-16 pb-12 border-t border-brand-900/50">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-5 space-y-4">
            <a href="#" className="inline-flex items-center gap-2 text-2xl font-extrabold font-heading tracking-wider">
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              <a
                ...
                className="px-4 py-2 rounded-full bg-white/10 hover:bg-brand-500 text-xs font-semibold tracking-wider transition-colors flex items-center gap-1.5"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 py-2 rounded-full bg-emerald-600/80 hover:bg-emerald-500 text-xs font-semibold tracking-wider transition-colors flex items-center gap-1.5"
              >
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400">
          ...
          <button
            onClick={scrollToTop}
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 hover:bg-brand-500 hover:text-white transition-colors text-gray-300 text-xs font-semibold"
          >
